...
// Pulling HTML from markdown
let converter: Converter = new showdown.Converter();

let markdown: string = fs.readFileSync('./src/public/data/test.md', 'utf8');
let html: string = converter.makeHtml(markdown);


// Manually setting blog data
type Blog = {
  id: number;
  title: string;
